...
const generateEmployeeData = (finishedEmployeeArray) => {
  console.log(finishedEmployeeArray)
  for (i = 0; i = finishedEmployeeArray.length; i++ ) {
    console.log(finishedEmployeeArray[i])
    createCard(finishedEmployeeArray[i])
  }  
}
...
module.exports = {generateEmployeeData, createCard, writeFile}
